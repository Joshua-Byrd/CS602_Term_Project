...
router.get("/books/remove-read-list/:id", bookRoutes.removeBookFromReadList);
...
router.get(
  "/books/remove-want-to-read-list/:id",
  bookRoutes.removeBookFromWantToReadList
);

//display user read list
router.get("/books/read-list", bookRoutes.displayUserReadList);

//display user want-to-read list
router.get("/books/want-to-read-list", bookRoutes.displayUserWantToReadList);

//edit user profile
router.get("/user/profile/edit", bookRoutes.editUserProfile);

//save user profile edit to database
router.post("/user/profile/edit", bookRoutes.saveUserProfileEditToDatabase);
